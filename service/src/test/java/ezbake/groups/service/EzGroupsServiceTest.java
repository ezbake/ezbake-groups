...
public class EzGroupsServiceTest {
    private static Logger logger = LoggerFactory.getLogger(EzGroupsServiceTest.class);
    ...
    public void testCreateAppUser() throws TException {
        ...
        String expectedAppGroupName = Joiner.on(".").join(Group.COMMON_GROUP, Group.APP_GROUP, appName);
        String expectedAppAccessGroupName = Joiner.on(".").join(Group.COMMON_GROUP, Group.APP_ACCESS_GROUP, appName);
    ...
    public void appUserGetsAuditsGroup() throws TException {
        ...
        String appGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP, appName);
        String auditsGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP,
                appName, EzGroupNamesConstants.AUDIT_GROUP);
        ...
        Vertex auditsGroupV = graph.query()
                .has(Group.GROUP_NAME, Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                        .join(EzGroupNamesConstants.ROOT, auditsGroup))
                .vertices()
                .iterator().next();
        ...
        if (e.hasNext()) {
            ...
            Assert.assertEquals(
                    Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, appGroup),
    ...
    public void appUserGetsMetricsGroup() throws TException {
        ...
        String appGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP, appName);
        String metricsGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP,
                appName, EzGroupNamesConstants.METRICS_GROUP);
        ...
        Vertex auditsGroupV = graph.query()
                .has(Group.GROUP_NAME, Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                        .join(EzGroupNamesConstants.ROOT, metricsGroup))
                .vertices()
                .iterator().next();
    ...
    public void appUserGetsDiagnosticGroup() throws TException {
        ...
        String appGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP, appName);
        String diagnosticGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.APP_GROUP,
                appName, EzGroupNamesConstants.DIAGNOSTICS_GROUP);
        ...
        Vertex auditsGroupV = graph.query()
                .has(Group.GROUP_NAME, Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                        .join(EzGroupNamesConstants.ROOT, diagnosticGroup))
                .vertices()
                .iterator().next();
    ...
    public void testCreateNoParent() throws TException {
        ...
        // Look for the group
        String expectedGroupName = Joiner.on(".").join(Group.COMMON_GROUP, groupName);
    ...
    public void testCreateWithParent() throws TException {
        ...
        String expectedGroupName1 = Joiner.on(".").join(Group.COMMON_GROUP, groupName1);
        String expectedGroupName2 = Joiner.on(".").join(Group.COMMON_GROUP, groupName1, groupName2);
    ...
    public void testGetGroupsMask() throws TException {
        ...
        String groupName21 = "Group2.1";
        String groupName22 = "Group2.2";
        ...
        String realG1 = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, groupName1);
        String realG2 = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, groupName2);
        String realG21 = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, groupName2, groupName21);
        String realG22 = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, groupName2, groupName22);
        String realG3 = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(EzGroupNamesConstants.ROOT, groupName3);
        ...
        Set<Long> receivedIndices = service.getGroupsMask(userToken, Sets.newHashSet(
                groupName2,
                Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(groupName2, groupName21),
                Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP).join(groupName2, groupName22)));
    ...
    public void testGetChildGroups() throws TException {
        ...
        String expectedGroupName2 = Joiner.on(".").join(groupName1, groupName2);
        String expectedGroupName3 = Joiner.on(".").join(groupName1, groupName3);
        String expectedGroupName4 = Joiner.on(".").join(expectedGroupName3, groupName4);
    ...
    public void testGetChildGroupsRecurse() throws TException {
        ...
        String expectedGroupName2 = Joiner.on(".").join(groupName1, groupName2);
        String expectedGroupName3 = Joiner.on(".").join(groupName1, groupName3);
        String expectedGroupName4 = Joiner.on(".").join(groupName1, groupName3, groupName4);
    ...
    public void getDiagnosticUsers() throws TException {
        ...
        String diagnosticGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                .join(EzGroupNamesConstants.APP_GROUP, "app1", EzGroupNamesConstants.DIAGNOSTICS_GROUP);
    ...
    public void getMetricsUsers() throws TException {
        ...
        String diagnosticGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                .join(EzGroupNamesConstants.APP_GROUP, "app1", EzGroupNamesConstants.METRICS_GROUP);
    ...
    public void getAuditUsers() throws TException {
        ...
        String diagnosticGroup = Joiner.on(EzGroupNamesConstants.GROUP_NAME_SEP)
                .join(EzGroupNamesConstants.APP_GROUP, "app1", EzGroupNamesConstants.AUDIT_GROUP);
