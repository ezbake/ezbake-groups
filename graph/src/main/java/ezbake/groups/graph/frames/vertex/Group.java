...
public interface Group extends BaseVertex {
    /* Special group names */
    public static final String COMMON_GROUP = EzGroupNamesConstants.ROOT;
    public static final String APP_GROUP = EzGroupNamesConstants.APP_GROUP;
    public static final String APP_ACCESS_GROUP = EzGroupNamesConstants.APP_ACCESS_GROUP;
