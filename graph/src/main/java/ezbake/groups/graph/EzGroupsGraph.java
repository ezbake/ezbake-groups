...
public class EzGroupsGraph implements Closeable {
    ...
    public static final String GROUP_NAME_SEP = EzGroupNamesConstants.GROUP_NAME_SEP;
    ...
    public Object createCommonGroup() {
        ...
        Iterator<Vertex> v = graph.query()
                .has(BaseVertex.INDEX, 0)
                .has(Group.GROUP_NAME, EzGroupNamesConstants.ROOT)
                .limit(1)
                .vertices().iterator();
        if (!v.hasNext()) {
            try {
                ...
                cg.setName(EzGroupNamesConstants.ROOT);
                cg.setGroupName(EzGroupNamesConstants.ROOT);
                cg.setIndex(0l);
                idProvider.setCurrentID(0l);
                cg.setType(BaseVertex.VertexType.GROUP);
                commonId = cg.asVertex().getId();
                logger.info("Created common group with name: {}, index:{}", EzGroupNamesConstants.ROOT, 0);
            } catch (Exception e) {
                graph.rollback();
     ...
     */
    public Group addGroup(BaseVertex.VertexType ownerType, String ownerPrincipal, String groupName) throws VertexExistsException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    ) throws UserNotFoundException, AccessDeniedException, VertexExistsException, IndexUnavailableException {
    ...
    public Group addGroup(BaseVertex.VertexType ownerType, String ownerID, String groupName, String parentGroup,
                           GroupInheritancePermissions inheritance, UserGroupPermissions permissions,
                           boolean requireOnlyUser, boolean requireOnlyApp
    ) throws UserNotFoundException, AccessDeniedException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
    ...
    protected Group addGroup(BaseVertex.VertexType ownerType, String ownerPrincipal, String groupName, String parentGroup) throws VertexExistsException, UserNotFoundException, AccessDeniedException, IndexUnavailableException, VertexNotFoundException {
    ...
    protected Group addGroup(BaseVertex.VertexType ownerType, String ownerPrincipal, String groupName, Group parentGroup) throws VertexExistsException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    protected Group addGroup(BaseVertex.VertexType ownerType, String ownerPrincipal, String groupName, Vertex parent) throws VertexExistsException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    protected Group addGroup(BaseVertex.VertexType ownerType, String ownerPrincipal, String groupName, Vertex parent,
                              GroupInheritancePermissions inheritance, UserGroupPermissions permissions,
                              boolean requireOnlyUser, boolean requireOnlyApp
    ) throws AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
        ...
        // Find the owner
        User owner;
        Iterator<User> ownerit = framedGraph.query().limit(1).has(User.TYPE, ownerType.toString()).has(User.PRINCIPAL, ownerPrincipal).vertices(User.class).iterator();
        if (!ownerit.hasNext()) {
    ...
    private Group addGroupPrivileged(Vertex parent, Vertex owner, String groupName,
                                      GroupInheritancePermissions inheritance, UserGroupPermissions permissions,
                                      boolean requireOnlyUser, boolean requireOnlyApp
    ) throws VertexExistsException, IndexUnavailableException {
    ...
    public Group getGroup(String groupName) throws VertexNotFoundException {
        ...
        Iterator<Group> g = framedGraph.query()
                .has(Group.GROUP_NAME, groupName)
                .has(BaseVertex.TYPE, BaseVertex.VertexType.GROUP.toString())
                .limit(1)
    ...
    public void setGroupInheritance(String groupName, boolean dataAccess, boolean adminRead, boolean adminWrite, boolean adminManage, boolean adminCreateChild) throws VertexNotFoundException {
        Iterator<Vertex> gs = graph.query().has(Group.GROUP_NAME, groupName).limit(1).vertices().iterator();
        if (!gs.hasNext()) {
