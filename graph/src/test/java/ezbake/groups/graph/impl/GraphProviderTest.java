...
public class GraphProviderTest {
    ...
    public void setUpGraphProvider() throws EzConfigurationLoaderException {
        ezConfiguration = new EzConfiguration(new ClasspathConfigurationLoader("/graphconfig.properties")).getProperties();
        gp = new TitanGraphProvider(ezConfiguration);
    }

    @Test
    public void testGetGraph() {
        TitanGraph g = gp.getGraph(ezConfiguration);
    }
